...
public class JWTService {
    ...
    public boolean isTokenValid(String token,UserDetails userDetails){
        ...
        logger.info("Jwt exiration date"+this.jwtExpiration);
        logger.info("Extracted username validity: "+userDetails.getUsername());
        logger.info("token Expired "+isTokenExpired);
